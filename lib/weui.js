...
/***/ function(module, exports, __webpack_require__) {
	...
	function confirm() {
        ...
        //console.log(options);
		console.log(options.button[0].onClick,options.button[1].onClick);
	    options = _util2.default.extend({
	        content: content,
	        buttons: [{
	            label: options.button[0].label,
	            type: 'primary',
	            onClick: options.button[0].onClick
	        }, {
	            label: options.button[1].label,
	            type: 'primary',
	            onClick: options.button[1].onClick
	        }]
	    }, options);
